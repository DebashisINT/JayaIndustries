...
//                itemView.new_multi_view.visibility = View.GONE
            ...
            try{
                if(Pref.IsShowWhatsAppIconforVisit){
                    ...
                    }else if(shopWiseWhatsObj.isWhatsappSent){
                        itemView.ll_avg_shop_item_whatsapp_api.isEnabled = false
                        //itemView.tv_avg_shop_item_whatsapp_api.text = shopWiseWhatsObj.whatsappSentMsg
