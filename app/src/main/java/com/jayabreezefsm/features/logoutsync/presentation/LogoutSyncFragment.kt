package com.jayabreezefsm.features.logoutsync.presentation
...
import com.jayabreezefsm.CustomConstants


import com.jayabreezefsm.R
import com.jayabreezefsm.app.AppDatabase
import com.jayabreezefsm.app.NetworkConstant
...
import com.jayabreezefsm.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.jayabreezefsm.features.billing.api.AddBillingRepoProvider
import com.jayabreezefsm.features.billing.model.AddBillingInputParamsModel
...
import com.jayabreezefsm.features.dashboard.presentation.ReasonDialog
...
import com.jayabreezefsm.features.document.model.AddEditDocumentInputParams
import com.jayabreezefsm.features.document.model.DocumentAttachmentModel
...
import com.jayabreezefsm.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.jayabreezefsm.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.jayabreezefsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.jayabreezefsm.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.jayabreezefsm.features.orderhistory.model.*
...
import com.jayabreezefsm.features.quotation.model.AddQuotInputModel
import com.jayabreezefsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.jayabreezefsm.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.jayabreezefsm.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.jayabreezefsm.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.jayabreezefsm.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.jayabreezefsm.features.timesheet.model.AddTimeSheetInputModel
import com.jayabreezefsm.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.jayabreezefsm.features.viewAllOrder.model.AddOrderInputParamsModel
import com.jayabreezefsm.features.viewAllOrder.model.AddOrderInputProductList
import com.jayabreezefsm.mappackage.SendBrod
import com.jayabreezefsm.widgets.AppCustomTextView
import com.jayabreezefsm.MonitorService
import com.jayabreezefsm.MySingleton
import com.jayabreezefsm.features.addshop.model.*
import com.jayabreezefsm.features.addshop.model.assigntopplist.AddShopUploadImg
import com.jayabreezefsm.features.addshop.presentation.ShopExtraContactReq
import com.jayabreezefsm.features.addshop.presentation.multiContactRequestData
import com.jayabreezefsm.features.login.api.LoginRepositoryProvider
import com.jayabreezefsm.features.login.model.GetConcurrentUserResponse
import com.jayabreezefsm.features.login.model.WhatsappApiData
import com.jayabreezefsm.features.performance.model.Gps_status_list
import com.jayabreezefsm.features.performance.model.UpdateGpsInputListParamsModel
import com.jayabreezefsm.features.returnsOrder.ReturnProductList
import com.jayabreezefsm.features.returnsOrder.ReturnRequest
import com.jayabreezefsm.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xjayabreezefsmlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xjayabreezefsmlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xjayabreezefsmlogsample/log.zip").path);
